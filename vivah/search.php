    ...
    <div class="col-sm-7 form_radios">
      <div class="select-block1">
        <select name="district">
            ...
            <option value="Wayanad">Meerut</option>
            <option value="Calicut">Delhi</option>
            <option value="Malappuram">Mumbai</option> 
            <option value="Trivandrum">Kanpur</option> 
            <option value="Kannur">Ghaziabad</option> 
            <option value="Kasargode">Goa</option>
        </select>
      </div>
    </div>
    <div class="clearfix"> </div>
    ...
    <div class="col-sm-7 form_radios">
      <div class="select-block1">
        <select name="state">
            ...
            <option value="Kerala">Uttar Pradesh</option>
    ...
    <div class="col-sm-7 form_radios">
      <div class="select-block1">
        <select name="religion">
            ...
            <option value="Jain-All">Jain</option>
            <option value="Jain-Digambar">Rajput</option>
            <option value="Muslim-All">Muslim</option> 
            <option value="Christian-All">Christian</option> 
        </select>
      </div>
    </div>
    <div class="clearfix"> </div>
